...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ActionRecovery")));
bytes32 constant ActionRecoveryTableId = _tableId;

library ActionRecovery {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ActionRecovery", _fieldNames);
  }
