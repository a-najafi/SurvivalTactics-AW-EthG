...
library MapConfig {
  ...
  /** Get width */
  function getWidth(bytes32 entity) internal view returns (uint32 width) {
  ...
  function getWidth(IStore _store, bytes32 entity) internal view returns (uint32 width) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  /** Set width */
  function setWidth(bytes32 entity, uint32 width) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  function setWidth(IStore _store, bytes32 entity, uint32 width) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  /** Get height */
  function getHeight(bytes32 entity) internal view returns (uint32 height) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  function getHeight(IStore _store, bytes32 entity) internal view returns (uint32 height) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  /** Set height */
  function setHeight(bytes32 entity, uint32 height) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  function setHeight(IStore _store, bytes32 entity, uint32 height) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  /** Get the full data */
  function get(bytes32 entity) internal view returns (uint32 width, uint32 height) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  function get(IStore _store, bytes32 entity) internal view returns (uint32 width, uint32 height) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  function set(bytes32 entity, uint32 width, uint32 height) internal {
  ...
  function set(IStore _store, bytes32 entity, uint32 width, uint32 height) internal {
    bytes memory _data = encode(width, height);
