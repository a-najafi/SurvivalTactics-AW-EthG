...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("MovementCost")));
bytes32 constant MovementCostTableId = _tableId;

library MovementCost {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("MovementCost", _fieldNames);
  }
