...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("IsBearSpawner")));
bytes32 constant IsBearSpawnerTableId = _tableId;

library IsBearSpawner {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("IsBearSpawner", _fieldNames);
  }
