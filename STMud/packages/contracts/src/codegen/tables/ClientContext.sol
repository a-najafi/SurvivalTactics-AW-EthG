...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ClientContext")));
bytes32 constant ClientContextTableId = _tableId;
...
library ClientContext {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    return ("ClientContext", _fieldNames);
  }
  ...
  /** Get context */
  function get(bytes32 entity) internal view returns (string memory context) {
  ...
  function get(IStore _store, bytes32 entity) internal view returns (string memory context) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  /** Set context */
  function set(bytes32 entity, string memory context) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  function set(IStore _store, bytes32 entity, string memory context) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  function encode(string memory context) internal view returns (bytes memory) {
    uint40[] memory _counters = new uint40[](1);
    _counters[0] = uint40(bytes(context).length);
    PackedCounter _encodedLengths = PackedCounterLib.pack(_counters);

    return abi.encodePacked(_encodedLengths.unwrap(), bytes((context)));
  }
