...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("IsObstruction")));
bytes32 constant IsObstructionTableId = _tableId;

library IsObstruction {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("IsObstruction", _fieldNames);
  }
