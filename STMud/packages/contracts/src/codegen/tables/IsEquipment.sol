...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("IsEquipment")));
bytes32 constant IsEquipmentTableId = _tableId;
...
library IsEquipment {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("IsEquipment", _fieldNames);
  }
