...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("IsWolfSpawner")));
bytes32 constant IsWolfSpawnerTableId = _tableId;

library IsWolfSpawner {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("IsWolfSpawner", _fieldNames);
  }
