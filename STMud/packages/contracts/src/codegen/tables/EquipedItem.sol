...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("EquipedItem")));
bytes32 constant EquipedItemTableId = _tableId;
...
library EquipedItem {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("EquipedItem", _fieldNames);
  }
